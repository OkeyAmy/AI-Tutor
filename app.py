...
title_template =  PromptTemplate(
    ...
    template= 'Write a main title heading for this: {topic}'
)

content_template =  PromptTemplate(
    input_variables= ['title', 'wikipedia_research'],
    template= """
Write an extensive article starting with a sub-heading that is relevant to the title with an introduction following it.: {title}, including examples and code samples if necessary, while leveraging Wikipedia for research {wikipedia_research}.
"""
)
